...
- **Implemented 2026-04-24:** Option 2 is now in place via the smoke test's frontend SHA check. The live Bluehost page must include the injected `frontend-sha` marker or smoke fails with `frontend_stale`.
- **Remaining open work:**
